...
Method21(msg: "Текст", count: 4); // необязательно писать по порядку
*/
...
// Задача №1: дан текст, нужно в нем все пробелы заменить черточками, маленькие буквы "к" большими 
// "К", а маленькие "с" большими "С".
/*
Console.Clear();
